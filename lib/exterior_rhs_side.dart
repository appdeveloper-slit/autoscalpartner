...
// void main() => runApp(ExteriorRhsSide());

class ExteriorRhsSide extends StatefulWidget {
  @override
  State<ExteriorRhsSide> createState() => _ExteriorRhsSideState();
}

class _ExteriorRhsSideState extends State<ExteriorRhsSide> {
            ...
            child: Column(
              children: [
                ...
                Container(
                  ...
                  child: DropdownButtonHideUnderline(
                    child: DropdownButton<String>(
                      hint: Text("Select RHS Side Appron"),
                      value: selectedValue,
                      isExpanded: true,
                      icon: Icon(
                ...
                Container(
                  ...
                  child: DropdownButtonHideUnderline(
                    child: DropdownButton<String>(
                      hint: Text("Select Front RHS Tyre percentage"),
                      value: selectedValue,
                      isExpanded: true,
                      icon: Icon(
                        Icons.keyboard_arrow_down,
                ...
                Container(
                  ...
                  child: DropdownButtonHideUnderline(
                    child: DropdownButton<String>(
                      hint: Text("Select Front RHS Window"),
                      value: selectedValue,
                      isExpanded: true,
                      icon: Icon(
                        Icons.keyboard_arrow_down,
                ...
                Container(
                  ...
                  child: DropdownButtonHideUnderline(
                    child: DropdownButton<String>(
                      hint: Text("Select Front RHS Door"),
                      value: selectedValue,
                      isExpanded: true,
                      icon: Icon(
                        Icons.keyboard_arrow_down,
                ...
                Container(
                  ...
                  child: DropdownButtonHideUnderline(
                    child: DropdownButton<String>(
                      hint: Text("Select RHS Running Board"),
                      value: selectedValue,
                      isExpanded: true,
                      icon: Icon(
                        Icons.keyboard_arrow_down,
                ...
                Container(
                  ...
                  child: DropdownButtonHideUnderline(
                    child: DropdownButton<String>(
                      hint: Text("Select Rear RHS Percentage"),
                      value: selectedValue,
                      isExpanded: true,
                      icon: Icon(
                        Icons.keyboard_arrow_down,
                ...
                Container(
                  ...
                  child: DropdownButtonHideUnderline(
                    child: DropdownButton<String>(
                      hint: Text("Select RHS quater panel"),
                      value: selectedValue,
                      isExpanded: true,
                      icon: Icon(
                        Icons.keyboard_arrow_down,

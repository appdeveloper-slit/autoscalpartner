...
// void main() => runApp(ExteriorBackSide());

class ExteriorBackSide extends StatefulWidget {
  @override
  State<ExteriorBackSide> createState() => _ExteriorBackSideState();
}

class _ExteriorBackSideState extends State<ExteriorBackSide> {
            ...
            child: Column(
              children: [
                ...
                Container(
                  ...
                  child: DropdownButtonHideUnderline(
                    child: DropdownButton<String>(
                      hint: Text("Select Dicky Floor Condition"),
                      value: selectedValue,
                      isExpanded: true,
                      icon: Icon(
                        Icons.keyboard_arrow_down,
                ...
                Container(
                  ...
                  child: DropdownButtonHideUnderline(
                    child: DropdownButton<String>(
                      hint: Text("Select Spare Wheel Tyre percentage"),
                      value: selectedValue,
                      isExpanded: true,
                      icon: Icon(
                        Icons.keyboard_arrow_down,

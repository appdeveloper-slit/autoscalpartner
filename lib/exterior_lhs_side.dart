...
// void main() => runApp(ExteriorLHSSide());

class ExteriorLHSSide extends StatefulWidget {
  @override
  State<ExteriorLHSSide> createState() => _ExteriorLHSSideState();
}

class _ExteriorLHSSideState extends State<ExteriorLHSSide> {
